...
from models.Bisenet.resnet import resnet18, resnet34
from models.Bisenet.modules import ConvBnRelu, AttentionRefinement, FeatureFusion
...
class BiSeNet(nn.Module):
    name = 'Bisenet'
    def __init__(self, out_planes, pretrained_model=None,
                 norm_layer=nn.BatchNorm2d, head='r18'):
        ...
        if head == 'resnet18':
            ...
            raise NotImplementedError('Head in Bisenet')
        self.context_path = resnet(pretrained_model, norm_layer=norm_layer,
                                   bn_eps=bn_eps,
